# Generated by Django 3.2.15 on 2022-11-10 10:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_pic', models.ImageField(default='default/pro_pic.png', upload_to='profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('Male', 'Male'), ('Female', 'Female'), ('Others', 'Others')], max_length=12, null=True)),
                ('followers', models.ManyToManyField(related_name='followerslist', to=settings.AUTH_USER_MODEL)),
                ('following', models.ManyToManyField(related_name='followinglist', to=settings.AUTH_USER_MODEL)),
